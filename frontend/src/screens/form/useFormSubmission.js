  ...
  const submitForm = async (formData) => {
    ...
    try {
      ...
      const updateData = {
        ...
        restrictions: formData.restrictions && formData.restrictions.length > 0 ? formData.restrictions : undefined,
      ...
      let errorMessage = 'Error al guardar los datos. Por favor intenta nuevamente';
